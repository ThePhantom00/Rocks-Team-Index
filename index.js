// =======Options START=======
var authConfig = {
  siteName: "Rocks-Team Index", // 网站名称
  version: "1.1.2", // 程序版本
  theme: "acrou",
  // 强烈推荐使用自己的 client_id 和 client_secret
  client_id: "202264815644.apps.googleusercontent.com",
  client_secret: "X4Z3ca8xfWDb1Voo-F9a7ZxJ",
  refresh_token: "1//0dEb9GIB9l5rtCgYIARAAGA0SNwF-L9IrKShQcYVhtvQU25zph9nbVoDTSlnlGVUvmYiHe_YcmQ8-epD_Znv-LqQ8yHlaEASCqUE", // 授权 token
  /**
  ...
  "roots": [
	{
		"id": "1J7C5avmMlLj1P1RpK_VfZN7Tx5V6Abem",
		"name": "Rocks-Team",
		"user": "",
		"pass": "",
...
<html>
<head>
<meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0,maximum-scale=1.0, user-scalable=no"/> <title>${authConfig.siteName}</title> <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1"><meta name="description" content="سيرفر التحميل المباشر الخاص بفريق الروكس"><meta name="theme-color" content="#FF3300"><meta name="application-name" content="Rocks Team Index"><meta name="robots" content="index, follow"><meta name="twitter:card" content="summary"><meta name="twitter:image" content="https://i.imgur.com/EVwnF9D.jpg"><meta name="twitter:description" content="السيرفر الخاص بفريق الروكس"><meta name="keywords" content="goindex, google, drive, goindex, gdindex, classic, material, workers-script, oauth-consent-screen, google-drive, cloudflare-workers, themes"><meta name="twitter:title" content="Rocks Team Index"><meta name="twitter:url" content="https://github.com/alx-xlx/goindex"><link rel="shortcut icon" href="https://i.imgur.com/EVwnF9D.jpg"><meta property="og:site_name" content="Rocks Team Index"><meta property="og:type" content="website"><meta property="og:image" content="https://i.imgur.com/EVwnF9D.jpg"><meta property="og:description" content="السيرفر الخاص بفريق الروكس"><meta property="og:title" content="Goindex"><meta property="og:url" content="https://github.com/alx-xlx/goindex"><link rel="apple-touch-icon" href="https://i.imgur.com/EVwnF9D.jpg"><link rel="icon" type="image/png" sizes="32x32" href="https://i.imgur.com/EVwnF9D.jpg"><meta name="google-site-verification" content="OD_AXMYw-V6ID9xQUb2Wien9Yy8IJSyfBUyejYNB3CU"/><script async src="https://www.googletagmanager.com/gtag/js?id=UA-86099016-6"></script><script>window.dataLayer=window.dataLayer || []; function gtag(){dataLayer.push(arguments);}gtag('js', new Date()); gtag('config', 'UA-86099016-6');</script><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-MR47R4M');</script> <style>@import url(${themeOptions.cdn}@${themeOptions.version}/goindex-acrou/dist/style.min.css); </style> <script>window.gdconfig=JSON.parse('${JSON.stringify({version: authConfig.version, themeOptions: themeOptions,})}'); window.themeOptions=JSON.parse('${JSON.stringify(themeOptions)}'); window.gds=JSON.parse('${JSON.stringify( authConfig.roots.map((it)=> it.name) )}'); window.MODEL=JSON.parse('${JSON.stringify(model)}'); window.current_drive_order=${current_drive_order}; </script>
</head>
<body>
